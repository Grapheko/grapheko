    ...
    <>
      ...
      <nav style={{position:'fixed',top:0,left:0,right:0,zIndex:50,padding:'0 24px',height:'60px',display:'flex',alignItems:'center',justifyContent:'space-between',background:'rgba(8,8,8,.95)',backdropFilter:'blur(12px)',borderBottom:'0.5px solid var(--border)'}}>
        ...
        <div style={{display:'flex',alignItems:'center',gap:'16px'}}>
          <Link href="/blog" style={{fontFamily:'var(--mono)',fontSize:'12px',color:'var(--text-secondary)',textDecoration:'none'}}>← ./blog</Link>
          <div className="desktop-nav" style={{display:'flex',alignItems:'center',gap:'20px'}}>
            {[['./ressources','/ressources'],['./newsletter','/newsletter']].map(([l,h])=>(
